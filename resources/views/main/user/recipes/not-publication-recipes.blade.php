...
@section('title', 'FoodKing Blog | Неопубликованные рецепты')
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="content-area">
                                ...
                                @if (count($notPublicationRecipes) == 0)
                                    <h2>Рецепты не найдены...</h2>
                                @else
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="breadcrumb__text">
                                                <h2>Неопубликованные рецепты</h2>
                                            </div>
                                        </div>
                                    </div>
                                    @foreach($notPublicationRecipes as $recipe)
